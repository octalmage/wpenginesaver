...
static NSString * const DEFAULT_URL = @"https://json.wpengine.com/screensaver/";
static NSString * const DEFAULT_USERSCRIPT = @"document.body.style.backgroundColor = '#022B42';";
